...
/// Functions to query AdminpanelRecords (as a Stream and as a Future).
Future<int> queryAdminpanelRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      AdminpanelRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<AdminpanelRecord>> queryAdminpanelRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      AdminpanelRecord.collection,
      AdminpanelRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<AdminpanelRecord>> queryAdminpanelRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query DateBlockerRecords (as a Stream and as a Future).
Future<int> queryDateBlockerRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      DateBlockerRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<DateBlockerRecord>> queryDateBlockerRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      DateBlockerRecord.collection,
      DateBlockerRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<DateBlockerRecord>> queryDateBlockerRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query AdminAddPatientRecords (as a Stream and as a Future).
Future<int> queryAdminAddPatientRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      AdminAddPatientRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<AdminAddPatientRecord>> queryAdminAddPatientRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      AdminAddPatientRecord.collection,
      AdminAddPatientRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<AdminAddPatientRecord>> queryAdminAddPatientRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
