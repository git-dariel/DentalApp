...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color alternate = const Color(0xFFEDEFF1);
  late Color primaryText = const Color(0xFF1A1F24);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x4D4B39EF);
  late Color accent2 = const Color(0x4CFBAF7C);
  late Color accent3 = const Color(0x4D39D2C0);
  late Color accent4 = const Color(0x9AF1F1F1);
  late Color success = const Color(0xFF32B8A8);
  late Color warning = const Color(0xFFE5CA54);
  late Color error = const Color(0xFFFC637A);
  late Color info = const Color(0xFFFFFFFF);

  late Color background = Color(0xFF1A1F24);
  late Color darkBackground = Color(0xFF111417);
  late Color textColor = Color(0xCCFFFFFF);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFFFBAF7C);
  late Color tertiary = const Color(0xFF39D2C0);
  late Color alternate = const Color(0xFF2A3137);
  ...
  late Color accent2 = const Color(0x4CFBAF7C);
  late Color accent3 = const Color(0x4D39D2C0);
  late Color accent4 = const Color(0xB32A3137);
  late Color success = const Color(0xFF32B8A8);
  late Color warning = const Color(0xFFE5CA54);
  late Color error = const Color(0xFFFC637A);
  late Color info = const Color(0xFFFFFFFF);
