...
import 'appointment_details_copy_model.dart';

export 'appointment_details_copy_model.dart';
...
class _AppointmentDetailsCopyWidgetState
  ...
  late AppointmentDetailsCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppointmentDetailsCopyModel());
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            appointmentDetailsCopyAppointmentsRecord
                                .appointmentType,
                    ...
                    child: Padding(
                      ...
                      child: StreamBuilder<AppointmentsRecord>(
                        stream: AppointmentsRecord.getDocument(
                            appointmentDetailsCopyAppointmentsRecord.reference),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                          if (!snapshot.hasData) {
                            return Center(
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await appointmentDetailsCopyAppointmentsRecord.reference
                            .delete();
